                    ...
                    >
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-1">
                          {isTopPick && (
                            <span className="text-yellow-500" title="Curator's Top Pick">
                              ⭐
                            </span>
                          )}
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex items-center gap-2 justify-end">
                          <button
                            onClick={async () => {
                              await onUpdate(restaurant.id, { 
                                curatorsTopPick: isTopPick ? 'false' : 'true' 
                              });
                            }}
                            ...
                            title={isTopPick ? 'Remove from Top Picks' : 'Mark as Curator\'s Top Pick'}
                          >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill={isTopPick ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2">
